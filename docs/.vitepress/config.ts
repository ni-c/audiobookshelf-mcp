...
const site = 'https://audiobookshelf-mcp.ni-c.de';
const description =
  'MCP server for Audiobookshelf: browse your libraries, ask what you own and what you have listened to, and keep progress, bookmarks, collections and playlists in sync.';
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'audiobookshelf-mcp' }],
    ['meta', { property: 'og:title', content: 'audiobookshelf-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Releases',
            link: 'https://github.com/ni-c/audiobookshelf-mcp/releases',
          },
          {
            text: 'npm package',
            link: 'https://www.npmjs.com/package/audiobookshelf-mcp',
          },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is audiobookshelf-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/audiobookshelf-mcp' },
    ...
    editLink: {
      pattern:
        'https://github.com/ni-c/audiobookshelf-mcp/edit/main/docs/:path',
