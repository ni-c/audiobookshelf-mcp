 ...
 *
 * No coverage is collected here. What this suite proves is that Audiobookshelf behaves
 * as the code assumes, which is not a question about which lines ran.
 */
export default defineConfig({
  test: {
    include: ['test/integration/**/*.integration.test.ts'],
    // One story, shared state, one Audiobookshelf. Running the file's blocks against
